	...
	<div class="wrapper">
		<nav id="sidebar" style="background-color: #FFD54F;">
			...
			<ul class="list-unstyled components">
				...
				<li class="btn"
					style="background-color: #3cb371; padding-left: 10px; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; margin-left: 40px; margin-top: 20px; margin-right: 40px; width: 12rem;">
				...
				<li class="btn"
					style="background-color: #3cb371; padding-left: 10px; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; margin-left: 40px; margin-top: 25px; margin-right: 40px; width: 12rem;">
					<a href="../admindash"
